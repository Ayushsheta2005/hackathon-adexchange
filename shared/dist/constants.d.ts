...
export declare const NANOPAYMENT_UNIT_USDC: "0.01";
/** Minimum allowed floor price a seller may list. */
export declare const FLOOR_PRICE_MIN_USDC: "0.01";
/** Hard ceiling on any computed clearing price — hackathon invariant: ≤ $0.01 per action. */
export declare const MAX_CLEARING_PRICE_USDC: "0.01";
 ...
 */
export declare const GATEWAY_WALLET_ADDRESS: "0x0077777d7EBA4688BDeF3E311b846F25870A19B9";
/**
 ...
 */
export declare const ARC_TESTNET_USDC: "0x3600000000000000000000000000000000000000";
/**
 ...
 */
export declare const ARC_TESTNET_EXPLORER_BASE: "https://testnet.arcscan.app";
/** SSE event names the server emits; the UI subscribes by name. */
export declare const STREAM_EVENTS: {
    readonly connected: "connected";
    readonly auctionMatched: "auction.matched";
    readonly settlementConfirmed: "settlement.confirmed";
    readonly controlChanged: "control.changed";
};
