...
import { NexusMessageBubble } from "./NexusMessageBubble.js";

describe("<NexusMessageBubble />", () => {
    ...
    render(
      <NexusMessageBubble
        message={{
          id: "1",
          role: "assistant",
          content: "I'm **Nexus**, your assistant.",
          createdAt: new Date().toISOString(),
        }}
      />,
    );
    const strong = screen.getByText("Nexus", { selector: "strong" });
