          ...
          >
            <div className="flex flex-wrap items-start justify-between gap-2">
              <div>
                ...
                <div className="mt-1 flex flex-wrap items-center gap-2 font-nexus-mono text-[11px] text-[oklch(0.4_0.01_80)]">
              ...
              {editingFloorId === row.id ? (
                <div className="flex flex-wrap items-center gap-2">
                  <input
                    type="text"
                    className="w-28 rounded-md border border-[oklch(0.88_0.005_80)] px-2 py-1 font-nexus-mono text-[12px]"
