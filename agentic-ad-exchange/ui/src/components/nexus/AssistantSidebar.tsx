...
export function AssistantSidebar(): JSX.Element {
  ...
  return (
    <aside className="flex min-h-0 w-60 shrink-0 flex-col border-r border-[oklch(0.91_0.005_80)] bg-[oklch(0.97_0.005_80)] font-nexus">
      <div className="flex items-center gap-2 border-b border-[oklch(0.94_0.004_80)] px-4 py-4">
        <div className="flex h-[22px] w-[22px] items-center justify-center rounded-md bg-[oklch(0.18_0.01_80)] font-nexus-mono text-[10px] font-bold text-white">
          ADE
        </div>
        <div>
          <div className="text-sm font-semibold text-[oklch(0.18_0.01_80)]">Agentic Exchange</div>
          <div className="font-nexus-mono text-[10.5px] text-[oklch(0.55_0.006_80)]">
            Arc · USDC
          </div>
        </div>
      </div>
      ...
      <div className="mt-auto border-t border-[oklch(0.94_0.004_80)] p-3.5">
        <div className="flex items-center gap-2.5">
          ...
          <div className="min-w-0">
            ...
            <div className="truncate font-nexus-mono text-[10.5px] text-[oklch(0.55_0.006_80)]">
              demo session
            </div>
          </div>
          <span
