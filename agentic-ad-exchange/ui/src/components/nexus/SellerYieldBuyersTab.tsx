          ...
          <tbody>
            {buyers.map((b) => (
              <tr key={b.id} className="border-b border-[oklch(0.96_0.004_80)] last:border-0">
                ...
                <td className="px-2 py-2 font-nexus-mono">{b.winsToday}</td>
                <td className="px-2 py-2 font-nexus-mono">{b.avgCpm}</td>
                <td className="px-2 py-2 font-nexus-mono">{b.pctRevenue}</td>
                <td className="px-3 py-2">
                  <button
                    type="button"
                    className={`rounded-full border border-[oklch(0.91_0.005_80)] bg-[oklch(0.99_0.003_80)] px-2 py-1 font-nexus-mono text-[10px] font-semibold uppercase hover:bg-[oklch(0.96_0.004_80)] ${statusStyle(b.status)}`}
