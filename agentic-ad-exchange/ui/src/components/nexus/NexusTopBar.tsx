...
export function NexusTopBar({ primary, secondary }: NexusTopBarProps): JSX.Element {
  ...
  return (
    <header
      ...
      className="flex h-[52px] shrink-0 items-center gap-3 border-b border-[oklch(0.91_0.005_80)] bg-[oklch(0.985_0.004_80)] px-5 font-nexus"
    >
      ...
      <div className="ml-auto flex items-center gap-3 font-nexus-mono text-[11.5px] text-[oklch(0.45_0.01_80)]">
