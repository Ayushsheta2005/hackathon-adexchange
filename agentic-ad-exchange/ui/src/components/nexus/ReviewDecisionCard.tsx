...
import type { ReviewDecision } from "./nexusRightPanelTypes.js";
...
export function ReviewDecisionCard({
  ...
  return (
    ...
    >
      ...
      >
        <span className="shrink-0 rounded border border-[oklch(0.91_0.005_80)] bg-[oklch(0.98_0.004_80)] px-1.5 py-0.5 font-nexus-mono text-[9px] font-semibold uppercase tracking-wide text-[oklch(0.4_0.01_80)]">
          {decision.tag}
        </span>
        ...
        <span className="shrink-0 font-nexus-mono text-[10.5px] text-[oklch(0.55_0.006_80)]">
          {decision.age}
        </span>
      </button>
      {expanded ? (
        <div className="border-t border-[oklch(0.94_0.004_80)] px-4 py-3">
          ...
          <p className="mt-3 text-[12.5px] font-medium text-[oklch(0.28_0.01_80)]">
            <span className="font-nexus-mono text-[9.5px] uppercase tracking-wider text-[oklch(0.55_0.006_80)]">
              Impact{" "}
            </span>
            {decision.impact}
          </p>
