            ...
            <tbody>
              {YIELD_PLACEMENT_ROWS.map((row) => (
                ...
                >
                  ...
                  <td className="px-2 py-2 font-nexus-mono">{row.fill}</td>
                  <td className="px-2 py-2 font-nexus-mono">{row.ecpm}</td>
                  <td className="px-2 py-2 font-nexus-mono">{row.revenue}</td>
                  <td className="px-3 py-2 font-nexus-mono font-medium">{row.vsFloor}</td>
                </tr>
              ))}
            </tbody>
          </table>
      ...
      <div>
        ...
        <div className="grid gap-2 sm:grid-cols-3">
          ...
          <div className="rounded-[10px] border border-[oklch(0.91_0.005_80)] border-l-[3px] border-l-blue-500 bg-white p-3 shadow-sm">
            <div className="font-nexus-mono text-[9px] font-semibold uppercase text-blue-900">
              Learned
            </div>
            <p className="mt-2 text-[11.5px] leading-snug text-[oklch(0.28_0.01_80)]">
