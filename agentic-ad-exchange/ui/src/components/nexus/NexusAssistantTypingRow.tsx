...
/** Typing indicator styled like an Nexus assistant bubble (CSS-only dots). */
export function NexusAssistantTypingRow({
  ...
  return (
    <div className="flex gap-3.5" aria-live="polite">
      <div className="mt-0.5 flex h-7 w-7 shrink-0 items-center justify-center rounded-lg bg-[oklch(0.18_0.01_80)] font-nexus-mono text-[10px] font-semibold tracking-wide text-white">
        ATL
      </div>
      <div className="min-w-0 flex-1">
        <div className="mb-1 flex flex-wrap items-baseline gap-2">
          ...
          <span className="font-nexus-mono text-[10.5px] text-[oklch(0.62_0.006_80)]">typing…</span>
        </div>
        <div
        ...
        >
          <span className="nexus-typing-dot inline-block h-1.5 w-1.5 rounded-full bg-[oklch(0.55_0.01_80)]" />
          <span className="nexus-typing-dot inline-block h-1.5 w-1.5 rounded-full bg-[oklch(0.55_0.01_80)]" />
          <span className="nexus-typing-dot inline-block h-1.5 w-1.5 rounded-full bg-[oklch(0.55_0.01_80)]" />
        </div>
      </div>
