  ...
  return (
    <div className="space-y-4">
      <div className="overflow-hidden rounded-[10px] border border-[oklch(0.91_0.005_80)] bg-white p-4 shadow-sm">
        <div className="flex flex-wrap items-start gap-3">
          <div className="flex min-w-0 flex-1 items-center gap-2">
            <h3 className="text-[13px] font-semibold text-[oklch(0.18_0.01_80)]">Nexus</h3>
            <span
              className="inline-flex h-2 w-2 shrink-0 rounded-full bg-emerald-500 shadow-[0_0_0_3px_rgba(16,185,129,0.25)] animate-pulse"
              aria-hidden
            />
            <span className="rounded border border-[oklch(0.91_0.005_80)] bg-[oklch(0.99_0.004_80)] px-2 py-0.5 font-nexus-mono text-[10px] font-medium uppercase tracking-wide text-[oklch(0.4_0.01_80)]">
              autonomous
            </span>
          </div>
          <button
        ...
        <p className="mt-2 font-nexus-mono text-[11px] text-[oklch(0.45_0.01_80)]">
      ...
      {exceptions.length === 0 ? (
        <div className="flex flex-col items-center justify-center rounded-[10px] border border-dashed border-[oklch(0.91_0.005_80)] bg-[oklch(0.995_0.003_80)] px-6 py-12 text-center">
          <p className="text-sm font-medium text-[oklch(0.28_0.01_80)]">
            Nexus is operating within policy
          </p>
        ...
        <div className="space-y-2">
            ...
            >
              <div className="flex items-start gap-2">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <button
                    type="button"
                    className="mt-2 text-left font-nexus-mono text-[11px] font-medium text-[oklch(0.32_0.01_80)] underline decoration-[oklch(0.85_0.01_80)] underline-offset-2 hover:text-[oklch(0.18_0.01_80)]"
                  >
                    {ex.actionLabel}
                  </button>
                </div>
          ...
          {overflow && !showAllExceptions ? (
            <button
              ...
              className="w-full rounded-lg border border-transparent py-2 text-center font-nexus-mono text-[11.5px] font-medium text-[oklch(0.36_0.01_80)] hover:bg-[oklch(0.96_0.004_80)]"
            >
      ...
      <details className="overflow-hidden rounded-[10px] border border-[oklch(0.91_0.005_80)] bg-white shadow-sm">
        <summary className="cursor-pointer list-none px-4 py-3 font-nexus-mono text-[10px] font-semibold uppercase tracking-wider text-[oklch(0.55_0.006_80)] marker:hidden [&::-webkit-details-marker]:hidden">
          <span className="select-none">Pacing</span>
        </summary>
        <div className="space-y-3 border-t border-[oklch(0.94_0.004_80)] px-4 py-3">
          {MOCK_PACING.map((row) => (
            <div key={row.name}>
              <div className="flex justify-between font-nexus-mono text-[10.5px] text-[oklch(0.42_0.01_80)]">
                <span>{row.name}</span>
                <span>
                  {row.pct}% · {row.label}
                </span>
      ...
      <div className="rounded-[10px] border border-[oklch(0.91_0.005_80)] bg-white shadow-sm">
        <button
          ...
          className="flex w-full items-center justify-between px-4 py-3 text-left font-nexus-mono text-[10px] font-semibold uppercase tracking-wider text-[oklch(0.55_0.006_80)] hover:bg-[oklch(0.99_0.004_80)]"
        >
          Live exchange
        ...
        {exchangeOpen ? (
          <div className="border-t border-[oklch(0.94_0.004_80)] p-4">
            <NexusExchangePulseCard {...exchange} />
          </div>
        ) : null}
      </div>
    </div>
