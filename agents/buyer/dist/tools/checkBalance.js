...
export function createCheckBalanceTool(deps) {
    const fetcher = deps.fetchImpl ?? fetch;
    return {
        name: "checkBalance",
        description: "Read the buyer wallet's on-chain USDC balance via the Exchange. Call before placing a bid so budget math uses fresh data.",
